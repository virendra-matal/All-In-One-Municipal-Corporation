...
@WebServlet(name = "Health_Dept_Servlet", urlPatterns = {"/Health_Dept_Servlet"})
public class Health_Dept_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Admin".equals(Municipal_User)) {
            ...
            List<department> health = dept.selectHealthDeptInfo(Admin_MCorp_Id);
            request.setAttribute("health", health);

        } else {
            int User_Municipal_corp_Id = (int) session.getAttribute("Municipal_corp_Id");
            DepartmentDao dept = new DepartmentDao();
            List<department> health = dept.selectHealthDeptInfo(User_Municipal_corp_Id);
            request.setAttribute("health", health);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Health_Dept_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
