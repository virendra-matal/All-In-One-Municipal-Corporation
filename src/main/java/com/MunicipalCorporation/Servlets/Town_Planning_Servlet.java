...
@WebServlet(name = "Town_Planning_Servlet", urlPatterns = {"/Town_Planning_Servlet"})
public class Town_Planning_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Admin".equals(Municipal_User)) {
            ...
            List<department> town = dept.selectTownPlanningDeptInfo(Admin_MCorp_Id);
            request.setAttribute("town", town);
        } else {
            int User_Municipal_corp_Id = (int) session.getAttribute("Municipal_corp_Id");
            DepartmentDao dept = new DepartmentDao();
            List<department> town = dept.selectTownPlanningDeptInfo(User_Municipal_corp_Id);
            request.setAttribute("town", town);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Town_Planning_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
