...
@WebServlet(name = "Fire_Dept_Servlet", urlPatterns = {"/Fire_Dept_Servlet"})
public class Fire_Dept_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Admin".equals(Municipal_User)) {
            ...
            List<department> fire = dept.selectFireDeptInfo(Admin_MCorp_Id);
            request.setAttribute("fire", fire);
        } else {
            int User_Municipal_corp_Id = (int) session.getAttribute("Municipal_corp_Id");
            DepartmentDao dept = new DepartmentDao();
            List<department> fire = dept.selectFireDeptInfo(User_Municipal_corp_Id);
            request.setAttribute("fire", fire);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Fire_Dept_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
