...
@WebServlet(name = "IT_Dept_Servlet", urlPatterns = {"/IT_Dept_Servlet"})
public class IT_Dept_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Admin".equals(Municipal_User)) {
            ...
            List<department> depart = dept.selectITDeptInfo(Admin_MCorp_Id);
            request.setAttribute("IT", depart);

        } else {
            int User_Municipal_corp_Id = (int) session.getAttribute("Municipal_corp_Id");
            DepartmentDao dept = new DepartmentDao();
            List<department> depart = dept.selectITDeptInfo(User_Municipal_corp_Id);
            request.setAttribute("IT", depart);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(IT_Dept_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
