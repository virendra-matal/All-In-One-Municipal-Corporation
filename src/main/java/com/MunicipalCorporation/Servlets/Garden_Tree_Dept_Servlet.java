...
@WebServlet(name = "Garden_Tree_Dept_Servlet", urlPatterns = {"/Garden_Tree_Dept_Servlet"})
public class Garden_Tree_Dept_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Admin".equals(Municipal_User)) {
            ...
            List<department> garden = dept.selectGarednANDTreeDeptInfo(Admin_MCorp_Id);
            request.setAttribute("garden", garden);
        } else {
            int Admin_MCorp_Id = (int) session.getAttribute("Municipal_corp_Id");
            DepartmentDao dept = new DepartmentDao();
            List<department> garden = dept.selectGarednANDTreeDeptInfo(Admin_MCorp_Id);
            request.setAttribute("garden", garden);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Garden_Tree_Dept_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
