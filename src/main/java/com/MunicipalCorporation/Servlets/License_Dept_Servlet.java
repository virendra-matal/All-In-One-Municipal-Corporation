...
@WebServlet(name = "License_Dept_Servlet", urlPatterns = {"/License_Dept_Servlet"})
public class License_Dept_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Admin".equals(Municipal_User)) {
            ...
            List<department> license = dept.selectLicenseDeptInfo(Admin_MCorp_Id);
            ...
            DepartmentDao dept = new DepartmentDao();
            List<department> license = dept.selectLicenseDeptInfo(User_Municipal_corp_Id);
            request.setAttribute("license", license);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(License_Dept_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
