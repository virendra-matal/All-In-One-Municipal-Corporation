    ...
    <body>
        ...
        <div class="screen">
                    ...
                    <div style=" position: fixed;">
                        <div class="content">
                            <table class="newtablecls" style="border: 1px;">
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center; background: #ccccff;"><b>Birth Certificate</b></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Mother Name:<span id="mother_name" class="span_left_space"> </span></td>
                                    <td colspan="2">Father Name:<span id="father_name" class="span_left_space"> </span></td>
                                </tr>
                                <tr>
                                    <td colspan="3">Residential place of Parent at the time of Birth as furnished for Birth Certificate:<span id="residential_place" class="span_left_space"> </span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td  colspan="3">Child full Name:<span id="child_name" class="span_left_space"> </span></td>
                                    <!--<td></td>-->
                                </tr>
                                <tr>
                                    <td>Name of Applicant:<span id="applicant_name" class="span_left_space"> </span></td>
                                    <td  colspan="2">Relation with Child:<span id="ralation" class="span_left_space"> </span></td>
                                </tr>
                                <tr>
            ...
            <script>
                ...
                var Birth_Registration_Id = jsarray[0];
//                alert(" Birth_Registration_Id  " + Birth_Registration_Id);

                $(document).ready(
                        callServlet()
                        );
                function callServlet() {
//                    alert("hii" + Birth_Registration_Id);
                    $.post("../Birth_Cert_View_Servlet", {Birth_registration_Id: Birth_Registration_Id}, function (data) {
                        for (var i = 0; i < data.length; i++) {
                            $("#date").text(data[i].Date);
                            $("#address").text(data[i].Address);
                            $("#mother_name").text(data[i].Mother_Name);
                            ...
                            $("#DOB").text(data[i].Date_Of_Birth);
                            $("#sex").text(data[i].Sex);
                            $("#child_name").text(data[i].Child_Name);
                            $("#applicant_name").text(data[i].Applicant_Name);
                            $("#ralation").text(data[i].Relation_with_Child);
                            $("#doc1").text(data[i].Id_proof);
                            $("#doc2").text(data[i].Parent_Marriage_Certificate);
                            $("#doc3").text(data[i].Letter_from_Hospital);
                            $("#doc4").text(data[i].Parent_Birth_Certificate);
                            $("#doc5").text(data[i].Signature);
