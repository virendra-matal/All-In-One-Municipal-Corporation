...
<html>
    <head>
        ...
        <title>License Department</title>
        <link href="../Css/License_Dept.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="screen">
            ...
            <div  class="left_side">
                ...
                <div class="dept_body">
                    ...
                    <table>
                        <jsp:include page="../License_Dept_Servlet" />
                        <%List<department> license = (ArrayList<department>) request.getAttribute("license");
                            for (department d : license) {%>
                        <tr>
                            <td class="dept_name">
                                <%=d.getDept_Name()%>
                            </td>
