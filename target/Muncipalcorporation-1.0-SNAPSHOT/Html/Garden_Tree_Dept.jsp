...
<html>
    <head>
        ...
        <title>Garden and Trees Department</title>
    ...
    <body>
        <div class="screen">
            ...
            <div  class="left_side">
                <div class="header">
                    <div class="marquee">
                        <marquee> WELCOME  TO  MUNICIPAL  CORPORATION OF INDIA </marquee>
                    </div>
                ...
                <div class="dept_body">
                    ...
                    <table>
                        <jsp:include page="../Garden_Tree_Dept_Servlet" />
                        <%List<department> garden = (ArrayList<department>) request.getAttribute("garden");
                            for (department d : garden) {%>
                        <tr>
                            <td class="dept_name">
                                <%=d.getDept_Name()%>
                            </td>
